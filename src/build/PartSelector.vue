...
import {Parts} from '../data/Interfaces';
...
export default Vue.extend({
  ...
  props: {
    parts: {
        // TypeScript will report incorrect error when an Array-type prop is present - https://github.com/vuejs/vue/issues/8421. As of 2018-08-10 
        // https://github.com/vuejs/vue/pull/6856 has not been merged yet.
      type: Array,
      default : () => []
    } as PropOptions<any[]>,
    position: {
      type: String, //Object as () => string,
      required: true,
      validator: function(value : string){
        return ['left','right','top','bottom','center'].indexOf(value) !== -1;
      },
    }
  },
  computed: {
